...
$MEMBERSTABLEHEADERTEXT = ["ID", "Name", "Address", "Email", "Phone", "Points", "History"];

$SALESREPORTINFOHEADERTEXT = ["Sales Report ID", "From Date", "To Date", "Date Made", "Details"];

$ORDERSSTABLEBODYKEY = ["order_id", "total_amount", "member_id", "redeemed_points", "earned_points", "discount", "final_amount", "date_made", "View"];
...
$SALESREPORTINFOKEY = ["sales_report_id", "from_date", "to_date", "date_made", "View"];

$MEMBERSTABLEBODYKEY = ["member_id", "fullname", "address", "email", "phone", "points", "View"];
